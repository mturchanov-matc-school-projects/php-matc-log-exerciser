     ...
     <?php
        ...
        if (isset($_POST['submit'])) 
        {
                    ...
                    && !empty($weight)) 
            {
                ...
                if (!empty($new_picture)) 
                {
                    $query = "UPDATE exercise_user SET first_name = '$first_name'"
                ...
                else 
                {
                    $query = "UPDATE exercise_user SET first_name = '$first_name', "
                            . "last_name = '$last_name', gender = '$gender', " 
                            . " birthdate = '$birthdate', weight = '$weight', "
                            . "picture = '$old_picture' WHERE user_id = '" . $_SESSION['user_id'] . "'";
                }
                ...
                {
                    echo '<p class="warn">You must enter all of the profile data (the picture is optional).</p>';
                }
        ...
        else 
        {
            ...
            $query = "SELECT first_name, last_name, gender, birthdate, weight,"
                     . "picture FROM exercise_user WHERE user_id = '" . $_SESSION['user_id'] . "'";
